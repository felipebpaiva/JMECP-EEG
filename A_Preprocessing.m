...
addpath('/Users/felipebrancodepaiva/Documents/EEGlab/eeglab2024.0');
eeglab;
...
addpath(genpath('/Users/felipebrancodepaiva/Documents/EEGlab/eeglab2024.0/plugins/mwf-artifact-removal-master'));
...
%addpath('C:\Analysis_Tools\eeglab2023.0\plugins\Fieldtrip-lite20210601'); % fieldtrip is automatically added to my path on startup
...
addpath('/Users/felipebrancodepaiva/Documents/EEGlab/eeglab2024.0/plugins/FastICA_25');
...
addpath('/Users/felipebrancodepaiva/Documents/EEGlab/eeglab2024.0/plugins/RELAX2.0.0');
...
RELAX_cfg.myPath='/Volumes/K_CCEMRC$/JMECP_EEG_Analysis/JMECP_BIDS/RELAX_prepro_EC_v2';
...
RELAX_cfg.ICLabel_thresholds=[0 0.8 0.8 0 0 0 0]; 
...
%% RUN SCRIPT BELOW:
RELAX_cfg.FilesToProcess=23:numel(RELAX_cfg.files); % Set which files to process
